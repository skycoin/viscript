...
func Clamp(f float32, negBoundary float32, posBoundary float32) float32 {
	if f < negBoundary {
		f = negBoundary
	}
	if f > posBoundary {
...
func ClampLeftAndRightOf(r *Rectangle, negBoundary float32, posBoundary float32) *Rectangle {
